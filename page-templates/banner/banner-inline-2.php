...
<section class="cta_inner flex align_c justify_fe dir_col inline <?php echo $banner_style; ?> <?php echo $banner_view; ?>">
        <div class="container flex align_fe justify_sb gap_24">
            ...
            <?php //if ( $subtitle ) : ?>
                <div class="cta_inner-subtitle tag regular"><?php echo $subtitle; ?></div>
            <?php //endif; ?>

            <div class="cta_inner-content text_l flex align_fe justify_sb gap_24 w_full">
                <?php if ( $title ) : ?>
                    <h2 class="cta_inner-title mb_0 white flex_auto"><?php echo $title; ?></h2>
                <?php endif; ?>

                <?php if ( $text ) : ?>
                    <div class="cta_inner-description white-25 fz_15 tt_u ff_mono"><?php echo $text; ?></div>
                <?php endif; ?>
            </div>

            <?php if ( $buttons && is_array( $buttons ) ) : ?>
                    <div class="cta_inner-buttons flex align_c justify_c gap_16 flex_auto flex_wrap">
