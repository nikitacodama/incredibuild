...
if (isset($data[$targetId])) {
    ...
    $monthsToROI = (($myObject['numOfDevs'] * $N14)/ $totalCostSavingWi); 
    //$monthsToROI = $myObject['numOfDevs']; 
...
.estimations_p           {padding:0 25px;color:#171E37;font-family: Gordita;font-size:12px;font-style: normal;line-height: 16px;width:700px;}
...
.lastpage                {background-image: url(https://www.incredibuild.com/wp-content/themes/incredibuild/roi_utils/images/lpagebg.png);height: 1050px;position:relative;background-repeat: no-repeat;background-position: center center;background-size: contain;text-align:center;}
...
Estimated ROI<br/>
<span class="concspan">'.bcdiv($monthsToROI, 1, 2).' Months</span>
</td>
</tr>
