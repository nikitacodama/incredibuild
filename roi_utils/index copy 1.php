...
if (isset($data[$targetId])) {
    ...
    $totalCostSavingWi = $annualDevelopersCostSaving + $fasterBrokenBuildResolutionValue + $moreTestingCostSaving + $annualInfraCostSavings + $annualCloudCostSavings;
    ...
    //echo "Total Cost Saving for $targetId: $totalCostSavingWi\n";
    
/*
    echo "$N8 <br>";
    echo "Average Local (Developer) build time with Incredibuild: $localDeveloperBuildTimeWi : Minutes<br>";
    echo "Centralized (CI) build time with Incredibuild: $centralizedBuildTimeWi : Minutes<br>";
    echo "Monthly build hours reduction: $buildHoursSaved : Hours <br>";
    echo "Monthly developer hours saved: $monthlyDeveloperHoursSaved : Hours<br>";
    echo "Annual developer productivity cost saving: $annualDevelopersCostSaving : $ <br>";
    echo "Potential Increase in daily CI build frequency :  $potentialIncreaseInCIBuildFrequency : Additional Cycles <br>";
    echo "Faster broken build resolution in time :  $fasterBrokenBuildResolutionTime : Hours<br>";
    echo "Faster broken build resolution in annual value :  $fasterBrokenBuildResolutionValue : $ <br>";
    echo "More time for testing :  $moreTimeForTesting : Monthly Hours <br>";
    echo "Annual cost saving due to more testing :  $moreTestingCostSaving : $ <br>";
    echo "Annual Value of faster critical bug fixes :  $fasterCriticalBugFixInAnnualValue  : $ <br>";
    echo "Potential number of additional annual releases :  $moreFrequentReleasePotential : Additional releases <br>";
    echo "Annual Infrastructure (on-prem) cost savings :  $annualInfraCostSavings : $ <br>";
    echo "Annual Cloud cost savings :  $annualCloudCostSavings  : $<br>";
    echo "Total Cost saving with Incredibuild :  $totalCostSavingWi :  $<br>";


    
    /*
    updateObjectAr(myObject_calc, "whenRunBuildsRc", wrcexpValu, "With Incredibuild you can run CI"," " );
    updateObjectAr(myObject_calc, "Fastercriticalbugfixintime ", N1*100,"Acceleration of critical bug fixes","%");
*/
...
@font-face {
   ...
   .h1 {
        margin-bottom: 40px;
        color: #171E37;
        font-family: "Gordita_Bold"; /* Use the exact font family name as specified in the font file */
        font-size: 45px;
    }
    p {color: #000;
        width: 459px;
...
.bgColorgrad {width: 563px;
height: 159px;
flex-shrink: 0;opacity: 0.45;
background: linear-gradient(116deg, #1EFFAE 4.14%, #4B0ECD 71.26%);

filter: blur(11.500001907348633px);}
.cntn {
    width: 552px;
height: 146px;
flex-shrink: 0;
...
.bottomlogos {  position:absolute; bottom:-10px; right:30px;}
span.header {display:inline-block;color: #FFF;
    ...
    span.number{display:block;
        ...
        font-style: normal;
        font-weight: 700;
        line-height: 34.897px; 
    }
    span.h2{   font-family:Poppins_bold;font-size: 23px;
        font-style: normal;
       }
...
.bgtable {width: 100%;padding:0px 33px;
                font-family: Poppins;
                background-repeat: no-repeat;
                background-position: center center;
                background-size: 100% 100%;
                background-image: url(https://www.incredibuild.com/wp-content/themes/incredibuild/roi_utils/images/page2top.png);
                height: 230px;color:#fff;margin-bottom:-30px;}
                ...
                .data1 td.datatdw {background-image: url(https://www.incredibuild.com/wp-content/themes/incredibuild/roi_utils/images/boxshadow.png);position:relative; border-radius: 6px;height: 43px;color:color: #171E37;padding:15px 10px 15px 10px;   font-family: Poppins;background-repeat: no-repeat;
    ...
    background-size: cover;}
               ...
               .lastpage{background-image: url(https://www.incredibuild.com/wp-content/themes/incredibuild/roi_utils/images/lpagebg.png);
               height: 1050px;
               position:relative;
               background-repeat: no-repeat;
               background-position: center center;
               background-size: contain;text-align:center;}
               .lastpage table{font-family: Poppins; font-size: 15px;color:#fff;text-align:center;width:500px;margin:auto;position:relative;top:400px;}
               .concspan {    font-family:Poppins_bold;font-size: 27px;line-height: 20px;}
    ...
    <body>
        ...
        <div class="page page_1">
            ...
            <p>This report outlines business value calculation results based on your data combined with Incredibuild’s decades of experience in various industries. We use an assumed acceleration rate of 75%, which aligns with the industry norm of 30% to 80%. The value metrics herein are grounded in conservative industry benchmarks to ensure the reliability of our calculations. </p>
        ...
        <tr>
            ...
            <div class="datawrap" style="  width: 794px;" >
                <table class="bgtable" border="0"  >
                    ...
                    Developer time saved<br/> 
                    due to faster builds
            ...
            <div class="datawrap" >
                <table class="data1" cellspacing="13">
                    ...
                    <tr>
                        ...
                        <span>'.number_format($annualDevelopersCostSaving).' hours</span>                        
                        </td>
                        <td class="datatd">
                        <div>Potential number of<br/>additional annual releases</div>
                        <span>'.$moreFrequentReleasePotential.' Releases</span>                       
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"> 
                    ...
                    <tr>
                    <td class="datatd">
                    <div>More time for testing</div>
                    <span>'.number_format($moreTimeForTesting).' Monthly Hours</span>
                </td>
                <td class="datatd">
                ...
                <td class="datatd">
                <div>Annual Value of faster<br/>critical bug fixes</div>
                <span>$'.number_format($fasterCriticalBugFixInAnnualValue).'</span>                        
                </td>
                <td> </td>
                    </tr>
                    <tr>
                        ...
                        <td  colspan="2"> 
                        <span class="h2">Infrastructure and Cloud</span>
                        </td>
                    </tr>
                    <tr>
                    <td class="datatd">
                    ...
                    <td class="datatd">
                    <div>Annual Infrastructure<br/>(on-prem) cost savings </div>
                    <span>$'.number_format($annualInfraCostSavings).'</span>                        
                    </td>
                    <td class="datatd">
                    <div>Annual Cloud cost savings </div>
                    <span>$'.number_format($annualCloudCostSavings).'</span>                        
                    </td>
                ...
                <table style="width:100%;border-collapse: collapse;" border="0"  cellspacing="13">
                 <tr>
                    <td style="height:120px;width:50%;">
                        ...
                        <tr><td colspan="2" class="datatitle">Local developer build time</td></tr>
                        <tr><td width="50" style="font-size:13px;">'. $myObject['averageDeveloperFullBuild'] .' min</td><td><div class="barGrey" style="width:100%;"> </div></td></tr>
                        <tr><td width="50" style="font-size:13px;">'. $myObject['averageDeveloperFullBuild']* 0.75 .'  min</td><td><div class="barGreen" style="width:75%;"> </div></td></tr>
                        <tr><td></td><td style="font-size:10px;line-height:8px;border-top:1px solid rgba(0, 0, 0, 0.22);"></td></tr>
                        </table>
                    </td>
                    <td style="padding:10px;">
                    <table border="0" style="width:100%;padding:20px;">
                    <tr><td colspan="2" class="datatitle">Ci  build time </td></tr>
                    <tr><td width="50" style="font-size:13px;">'. $myObject['centralizedBuildTake'] .' min</td><td><div class="barGrey" style="width:100%;"> </div></td></tr>
                    <tr><td width="50" style="font-size:13px;">'. $myObject['centralizedBuildTake'] * 0.75 .' min</td><td><div class="barGreen" style="width:75%;"> </div></td></tr>
                    <tr><td></td><td style="font-size:10px;line-height:8px; border-top:1px solid rgba(0, 0, 0, 0.22);"></td></tr>
                    </table>
                    </td>
                 </tr>
                 ...
                 <table border="0" style="width:100%;border-right:1px solid #c3c3c3;padding:20px;">
                 <tr><td colspan="2" class="datatitle">Potential additional CI cycles</td></tr>
                 <tr><td width="50" style="font-size:13px;">'.$myObject['CIBuildsPerDay'].'/day</td><td><div class="barGrey" style="width:100%;"> </div></td></tr>
                 <tr><td width="50" style="font-size:13px;">'.$potentialIncreaseInCIBuildFrequency.'/day</td><td><div class="barGreen" style="width:'. (100-(floor((($potentialIncreaseInCIBuildFrequency/$myObject['CIBuildsPerDay'])*100)))).'%;"> </div></td></tr>
                 <tr><td></td><td style="font-size:10px;line-height:8px; border-top:1px solid rgba(0, 0, 0, 0.22);"> </td></tr>
                 </table>                 
                 </td>
                    <td style="height:120px;">
                    <table style="width:100%;text-align:center;padding:20px;">
                    <tr><td class="small">With Incredibuild you can run CI </td></tr>
                    <tr><td class="datatitle">'.$wrcexpValu.'</td></tr>
                    </table>
                    </td>
                </tr>
                </table>
        ...
        <div class="page">
            <div class="datawrap" >
                ...
                <tr>
                    ...
                    <tr>
                    <td class="paragraph">Developer productivity gains are estimated by applying a productivity factor to time saved from reduced build durations.</td>
                    </tr>
                    <tr>
...
<table>
<tr>
<td style="width:50%; border-right:1px solid #fff;font-size:11px;">
...
<tr><td colspan="2" style="border-bottom:1px solid #fff;height:10px;"></td></tr>
<tr><td colspan="2" style="padding-top:10px;font-size:15px;line-height:12px;">For a more detailed analysis or to modify any of the<br/>assumptions in this report, an Incredibuild acceleration expert<br/>will be happy to help.
</td></tr>
