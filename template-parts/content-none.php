...
<section class="no-results not-found">
	...
	<div class="page-content">
		...
		if ( is_home() && current_user_can( 'publish_posts' ) ) :
			...
			printf(
				'<p>' . wp_kses(
					...
					__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'incredibuild' ),
					array(
						'a' => array(
							'href' => array(),
						),
		...
		elseif ( is_search() ) :
			...
			<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'incredibuild' ); ?></p>
			<?php
			get_search_form();
